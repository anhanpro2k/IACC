...
function init_Mona_OnePay_Domestic_class() {

    class Mona_OnePay_Domestic extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            $this->method_description = __('OnePay supports all major bank ATMs in Vietnam.', 'monamedia');
            $this->supports = array(
                'products',
            );
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'more_info' => array(
                    ...
                    'type' => 'title',
                    'description' =>
                    sprintf('URL: <code>%s</code>', Mona_OnePay_Domestic::get_onepay_ipn_url()) . '<p/>' .
                ...
                'debug' => array(
                    ...
                    'default' => 'no',
                    'description' => sprintf(__('Log events, such as IPN requests, inside %s', 'monamedia'), '<code>' . WC_Log_Handler_File::get_log_file_path('Mona_OnePay_Domestic') . '</code>'),
                ),
            );
        }
    ...
    function add_one_pay_gateway_class($methods) {
        $methods[] = 'Mona_OnePay_Domestic';
        return $methods;
    }

    add_filter('woocommerce_payment_gateways', 'add_one_pay_gateway_class');
}
